...
<section class="row posts">
   <div class="col-md-6 col-md-offset-3">
      ...
      <article class="post" data-postid="{{$post->id}}" data-postimg="{{Auth::user()->pic}}"
      data-postbody="{{$post->body}}">
         <p>
         <h4>{{$post->body}}</h4>
         </p>
         @if($post->image)
            ...
            <ul class="comments">
               ...
               <div class="comment">
                  <div class="comment-avatar">
                     <img src="{{ asset('images/' . Auth::user()->pic) }}" alt="{{ Auth::user()->name }}'s Avatar" width="20" height="20">         {{ $comment->content }}
                  </div>
               </div>
               @endif
               @endforeach
